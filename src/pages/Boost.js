  ...
  const upgradeCosts = [0, 2000, 5000, 10000, 20000, 40000, 80000, 100000, 150000, 200000, 250000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000, 1100000];


  const energyUpgradeCosts = [0, 3000, 6000, 12000, 24000, 50000, 100000, 200000, 300000, 400000, 600000, 800000, 1000000, 2000000, 21000000];
  ...
  const Boost = () => {
    ...
    <span className="font-medium tapguru2">{freeGuru}/3</span>
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col text-left">
                        <span className="font-semibold tapguru">Max Tank</span>
                        {fullTank> 0 ? (
    <span className="font-medium tapguru2">{fullTank}/3</span>
              ...
              <div className="w-full flex flex-col h-[50vh] pt-2 pb-[60px] overflow-y-auto">
                ...
                >
                  <button
                    ...
                    className={`${tapValue.level >= tapValues.length ? 'opacity-[.7]' : 'opacity-100'} bg-cards rounded-[12px] px-[14px] py-[8px] flex justify-between items-center`}
                  >
                    <div className="flex flex-1 items-center space-x-2">
                      <div className="">
                        <img src={multi} alt="multi" className="w-[40px]" />
                      </div>
                ...
                <>
                  ...
                  <button
                    ...
                    className={`${battery.level >= energyValues.length ? 'opacity-[.7]' : 'opacity-100'} bg-cards rounded-[12px] px-[14px] py-[8px] flex justify-between items-center`}
                  >
                    <div className="flex flex-1 items-center space-x-2">
                      <div className="">
                        <img src={battery3} alt="battery" className="w-[40px]" />
                      </div>
                      <div className="flex flex-col space-y-1 text-left">
                        <span className="font-semibold text-[17px]">
                          Energy Limit
                ...
                {formatNumber(nextEnergyUpgradeCost)}
                  ...
                  <button
                    ...
                    className={`${timeRefill.level >= chargingValues.length ? 'opacity-[.7]' : 'opacity-100'} bg-cards rounded-[12px] px-[14px] py-[8px] flex justify-between items-center`}
                  >
                    <div className="flex flex-1 items-center space-x-2">
                      <div className="">
                        <img src={flash} alt="flash" className="w-[40px]" />
                      </div>
                      <div className="flex flex-col space-y-1 text-left">
                        <span className="font-semibold text-[17px]">
                          Recharging Speed
                ...
                {formatNumber(nextChargingUpgradeCost)}
                  ...
                  >
                    <div className="flex flex-1 items-center space-x-2">
                      <div className="">
                        <img src={botr} alt="bot" className="w-[40px]" />
                      </div>
                      <div className="flex flex-col space-y-1 text-left">
              ...
              <div
                ...
                } absolute bottom-0 left-0 right-0 h-fit bg-[#222831] z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
              >
                ...
                <button
                  ...
                  <div className="w-full flex justify-center flex-col items-center">
                    <div className="w-[120px] h-[120px] rounded-[25px] bg-[#393E46] flex items-center justify-center">
                    ...
                    Increase amount of CUBESWAP you can earn per one tap <br/>
              ...
              <div className={`${congrats === true ? "visible bottom-6" : "invisible bottom-[-10px]"} z-[60] ease-in duration-300 w-full fixed left-0 right-0 px-4`}>
                <div className="w-full text-[#54d192] flex items-center space-x-2 px-4 bg-[#222831] h-[50px] rounded-[8px]">
