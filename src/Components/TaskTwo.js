    ...
    const handleTaskLinkClick = () => {
        window.open("https://t.me/cubeswap_update");
    ...
    const handleVerify = async () => {
        ...
        `https://api.telegram.org/bot7391569454:AAFMwfTALyJCi0khgyjSWU7TA9p3foVLib4/getChatMember?chat_id=-1002245144601&user_id=${id}`
        );
