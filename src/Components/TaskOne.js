...
const TaskOne = ({ showModal, setShowModal }) => {
  ...
  const handleTaskLinkClick = () => {
    window.open("https://t.me/cubeswapcom");
  ...
  const handleVerify = async () => {
    ...
    const response = await fetch(
      `https://api.telegram.org/bot7391569454:AAFMwfTALyJCi0khgyjSWU7TA9p3foVLib4/getChatMember?chat_id=-1002189091256&user_id=${id}`
    );
