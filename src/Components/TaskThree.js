...
const taskID = "task_3300"; // Assign a unique ID to this task
...
const handleTaskLinkClick = () => {
    window.open("https://t.me/cubeswap2024");
...
const handleVerify = async () => {
    ...
    `https://api.telegram.org/bot7391569454:AAFMwfTALyJCi0khgyjSWU7TA9p3foVLib4/getChatMember?chat_id=-1002221599482&user_id=${id}`
    );
    ...
    setTimeout(() => {
        setMessage(
        "Please join to the telegram channel first before you can claim this task bonus."
        );
    }, 1000);
    setCounter(15);
...
return (
    ...
    {showModal ? (
        ...
        <div className={`w-full flex flex-col items-center justify-start`}>
            ...
            } absolute bottom-0 left-0 right-0 h-[76vh] bg-[#222831] z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
            >
            <div className="w-full flex flex-col justify-between py-8">
                ...
                <div className="flex flex-1 items-center space-x-2">
                    ...
                    <div className="font-bold text-[20px]">1 000 000</div>
                </div>
                </div>
